using DotNetTypeGenerator.Tests.Unit.TestingClasses;
using DotNetTypeGenerator.Types;
...
using Xunit.Sdk;
using static DotNetTypeGenerator.Tests.Unit.TestingClasses.TestingClass;

namespace DotNetTypeGenerator.Tests.Unit;

public class TypeToTypeTests
{
    private readonly ITestOutputHelper _testOutputHelper;

    public TypeToTypeTests(ITestOutputHelper testOutputHelper)
    {
    ...
    public void CanWrapType()
    {
        ...
        var result = wrapper.CreateType(typeof(TestingClass));
    ...
    {
        var wrapper = new TypeToTypeWrapper();
        var originalType = typeof(TestingClass);
        var result = wrapper.CreateType(originalType);

        // Las propiedades son obviadas por defecto
    ...
    public void CanCreateSingleton()
    {
        ...
        var wrapper = new TypeToTypeWrapper();
        var result = wrapper.CreateType(typeof(TestingClass), options);
    ...
    public void CanRunCodeBeforeMethodExecutionUsingString()
    {
        var options = new TypeToTypeWrapperOptions()
        {
            OnBeforeMethodCustomCodeGenerator = (wrapperOptions, type, mi) =>
                "_instance.AddCount(4);"
        };
    ...
    public void CanRunCodeAfterMethodExecution()
    {
        var options = new TypeToTypeWrapperOptions()
        {
            OnAfterMethod = (wrapperOptions, type, inst, mi) =>
            {
                ((TestingClass)inst).AddCount(8);
            }
        };
        ...
        var instanceCount = instance.GetCount(); // Esta instancia solo registra los After de las últimas 3 llamadas
    ...
    public void CanRunCodeAfterMethodExecutionUsingString()
    {
        var options = new TypeToTypeWrapperOptions()
        {
            OnAfterMethodCustomCodeGenerator = (wrapperOptions, type, mi) =>
                "_instance.AddCount(18);"
        };
    ...
    public void CanRunCodeOnConstructorUsingString() 
    {
        var options = new TypeToTypeWrapperOptions()
        {
            OnConstructorCustomCodeGenerator = (wrapperOptions, type) =>
                "_instance.AddCount(21);"
        };
    ...
    public void CanAddCustomCode()
    {
        ...
        var options = new TypeToTypeWrapperOptions()
        {
            CustomCodeGenerator = (wrapperOptions, type) =>
                customCode
        };
    ...
    {
        var wrapper = new TypeToTypeWrapper();
        var result = wrapper.CreateType(typeof(TestingClassWithContructor),
            new TypeToTypeWrapperOptions()
            {
                Factory = (options, type) =>
                    new TestingClassWithContructor("Hello there")
            });
    ...
    public void CanAddConstructorParameters()
    {
        ...
        var constructor = result.GetConstructor(new[] 
        { 
            typeof(string) 
        });
    ...
    public void CanAddAdditionalNamespaces()
    {
        ...
        var result = wrapper.CreateType(typeof(TestingClass),
            new TypeToTypeWrapperOptions()
            {
                ...
                OnConstructorCustomCodeGenerator = (options, type) =>
                    "Debug.WriteLine(\"Hello\");"
            });
    }

    [Fact]
    public void ÁddsSourceCodeIntoPrivateFieldByDefault()
    {
        var wrapper = new TypeToTypeWrapper();
        var result = wrapper.CreateType(typeof(TestingClass),
            new TypeToTypeWrapperOptions()
            {
                CustomCodeGenerator = (options, type) =>
                    "public string GetCode() { return _source; }"
            });
    ...
    public void CanDisableSourceCodeField()
    {
        ...
        {
            wrapper.CreateType(typeof(TestingClass),
                new TypeToTypeWrapperOptions()
                {
                    CustomCodeGenerator = (options, type) =>
                        "public string GetCode() { return _source; }",
                    IsSourceCodeIncluded = false
                });
        });
    }
    ...
    public void CanAddOpenGenericConstructorParameter()
    {
        ...
        var constructor = result.GetConstructor(new[]
        {
            typeof(List<>).MakeGenericType(result)
        });
    ...
    public void CanIncludeSomeProperties()
    {
        var wrapper = new TypeToTypeWrapper();
        var result = wrapper.CreateType(typeof(Product),
            new TypeToTypeWrapperOptions() { IncludeProperties = new List<string>() { "Name", "Description" } });
        var properties = result.GetProperties();
    ...
    public void CanSetAndGetProperties()
    {
        var wrapper = new TypeToTypeWrapper();
        var result = wrapper.CreateType(typeof(Product), 
            new TypeToTypeWrapperOptions() { IncludeProperties = new List<string>() { "Name" } });
    ...
    public void CanIncludeGetOnlyProperties()
    {
        ...
        var result = wrapper.CreateType(typeof(ProductWithGetOnlyProperty),
            new TypeToTypeWrapperOptions() { IncludeProperties = new() { "*" } });
        var properties = result.GetProperties();
    ...
    {
        var wrapper = new TypeToTypeWrapper();
        var result = wrapper.CreateType(typeof(EntityImpl),
            new TypeToTypeWrapperOptions() { IncludeProperties = new() { "*" } });
        var properties = result.GetProperties();
    ...
    public void CanWrapGeneratedType()
    {
        ...
        var result = wrapper.CreateType(type,
            new()
            {
                ...
                AdditionalNamespaces = new() { type.Namespace },
    ...
    public void CanExcludeMethods()
    {
        ...
        var result = wrapper.CreateType(typeof(TestingClass),
            new()
            {
                ...
                {
                    var hasOverloads = type.GetMethods().Count(x => string.Equals(x.Name, mi.Name)) > 1;

                    if (hasOverloads == false)
                        return true;
        ...
        var addCountMethods = result.GetMethods().Where(x => x.Name == nameof(TestingClass.AddCount));
